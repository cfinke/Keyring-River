 ...
 * handled by a callback to keyring_river_comment() which is
...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="comment-list">
			<?php
				 ...
				 * define keyring_river_comment() and that will be used instead.
				 * See keyring_river_comment() in inc/template-tags.php for more.
				 */
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'keyring-river' ); ?></p>
	<?php endif; ?>
